                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <?php if(\Auth::user()->checkProject($project->id) == 'Owner'): ?>
                                <small><?php echo e(__('Attachment that uplaoded in this project')); ?></small>
                            <?php else: ?>
                                <small><?php echo e(__('Attachment that uplaoded in your assigned tasks')); ?></small>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\taskgo\resources\views/projects/show.blade.php ENDPATH**/ ?>