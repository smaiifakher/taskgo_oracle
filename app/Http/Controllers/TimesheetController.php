...
class TimesheetController extends Controller
{
    ...
    public function filterTimesheetTableView(Request $request)
    {
        ...
        if($request->has('week') && $request->has('project_id'))
        {
            ...
            if(!$seeAsOwner)
            {
                $projects_timesheet = $timesheets->where('timesheets.created_by', '=', $authuser->getCreatedBy());
            }
    ...
    public function timesheetCreate(Request $request)
    {
        ...
        $created_by = $user_id != null ? $user_id : $authuser->getCreatedBy();
    ...
    public function timesheetStore(Request $request)
    {
        ...
        if($project)
        {
            ...
            $timesheet->created_by  = $authuser->getCreatedBy();
            $timesheet->save();
