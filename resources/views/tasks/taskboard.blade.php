...
@section('action-button')
    {{--@if($view == 'list')
        <a href="{{ route('task.calendar') }}" class="btn btn-sm bg-white btn-icon rounded-pill mr-2 m-0">
            <span class="btn-inner--text text-dark">{{__('Calendar View')}}</span>
        </a>
    @else
        <a href="{{ route('taskBoard.view') }}" class="btn btn-sm bg-white btn-icon rounded-pill mr-2 m-0">
