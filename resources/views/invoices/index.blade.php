                            ...
                            <div class="card hover-shadow-lg">
                                            ...
                                            <div class="actions">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a href="#" class="dropdown-item" data-url="{{ route('invoices.edit',[$invoice->id]) }}" data-ajax-popup="true" data-size="md" data-title="{{__('Edit ').Auth::user()->invoiceNumberFormat($invoice->invoice_id)}}">
                                                            {{__('Edit')}}
                                                        </a>
                                ...
                                <div class="card-body pt-0">
                                    <div class="p-3 border border-dashed">
                                        <span class="text-sm text-muted font-weight-600">{{Auth::user()->invoiceNumberFormat($invoice->invoice_id)}}</span>
